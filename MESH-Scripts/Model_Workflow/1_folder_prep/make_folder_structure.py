...
catchmentShapeFolder    = read_from_control(controlFolder/controlFile,'input_basin_path')
...
forcingFolder = read_from_control(controlFolder/controlFile,'forcing_path')
#Specify the default path if required
...
drainageDatabaseFolder  = read_from_control(controlFolder/controlFile,'DDB_path')
networkTopologyFolder   = read_from_control(controlFolder/controlFile,'topology_path')
