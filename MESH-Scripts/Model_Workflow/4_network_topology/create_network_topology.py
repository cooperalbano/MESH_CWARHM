...
if river_network_path == 'default':
    river_network_path = make_default_path('{}/shapefiles/river_network/'.format(domainFolder)) # outputs a Path()
else:
...
if river_basin_path == 'default':
    river_basin_path = make_default_path('{}/shapefiles/catchment/'.format(domainFolder)) # outputs a Path()
else:
...
if topology_path == 'default':
    topology_path = make_default_path('{}/parameters/topology/'.format(domainFolder)) # outputs a Path()
else:
...
# Copy this script
thisFile = 'create_network_topology.py'
