...
target_shp = str(target_shp).replace('\\','/')
...
esmr.source_nc                = str(source_nc).replace('\\','/') 
...
# %% --- Code provenance
# Generates a basic log file in the domain folder and copies the control file and itesmr there.
...
# Copy this script
thisFile = '1_easymore_remapping.py'
