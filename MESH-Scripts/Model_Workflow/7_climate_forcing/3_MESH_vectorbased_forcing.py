...
forcing_dir     = '{}/domain_{}/forcing/'.format(rootPath,domain_name)
forcing_name    = 'RDRS_{}_remapped_1980-01-01-13-00-00.nc'.format(domain_name)
domain_name     = domain_name 
outdir          = '{}/domain_{}/parameters/drainagedatabase/'.format(rootPath,domain_name)
...
# Copy this script
thisFile = '3_MESH_vectorbased_forcing.py'
